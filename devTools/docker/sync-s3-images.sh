...
aws --endpoint=https://078fcdfed9955087315dd86792e71a7e.r2.cloudflarestorage.com s3 sync s3://owid-image-upload/production/ s3://$IMAGE_HOSTING_BUCKET_PATH/ --acl public-read